...
if (isset($_POST['sub'])) {
	...
	$sql = "INSERT INTO `contact us`(`u_name`, `u_email`, `u_sub`, `u_mess`)  VALUES ('$uname','$uemail','$subject','$mess')";
			...
			<div class="row">
				<div class="col-12 col-md-7 col-xl-8">
					<div class="row">
						...
						<div class="col-12">
							<form action="#" class="form form--contacts" method="post">
								<div class="row row--form">
									...
									<div class="col-12">
										<input type="text" class="form__input" placeholder="Subject" name="subject">
									</div>
									<div class="col-12">
										<textarea id="text" name="text" class="form__textarea" placeholder="Type your message..."></textarea>
									</div>
									<div class="col-12">
										<button type="submit" class="form__btn" name="sub"> Send</button>
									</div>
								</div>
							</form>
						</div>
				...
				<div class="col-12 col-md-5 col-xl-4">
					<div class="row">
						<!-- section title -->
						<div class="col-12">
							<h2 class="section__title section__title--mb">Info</h2>
						</div>
						<!-- end section title -->
						...
						<div class="col-12">
							...
							<ul class="contacts__list">
								...
								<li><a href="mailto:support@moviego.com">support@cineflix.template</a></li>
							</ul>
