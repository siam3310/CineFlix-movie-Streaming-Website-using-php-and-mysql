...
<body>
	...
	<div class="sidebar">
		...
		<div class="sidebar__nav-wrap">
			<ul class="sidebar__nav">
				...
				<li class="sidebar__nav-item">
					<a href="catalog.php" class="sidebar__nav-link sidebar__nav-link--active"><i class="icon ion-ios-film"></i> <span>Catalog</span></a>
				</li>
			...
			<div class="row">
				...
				<div class="col-12">
					<div class="main__title">
						...
						$sql9 = "SELECT COUNT(*) AS movie_count FROM
							...
							<tbody>
								...
								?>
									...
									<tr>
										...
										<td>
											<div class="main__table-text"><?php echo $row[13] ?></div>
										</td>
										<td>
										...
										<td>
											<div class="main__table-btns">
												...
												<a href="#modal-edit-<?= $catalog_id; ?>" class="main__table-btn main__table-btn--edit open-modal">
													<i class="icon ion-ios-create"></i>
												</a>
												<a href="#modal-delete-<?= $catalog_id; ?>" class="main__table-btn main__table-btn--delete open-modal">
	...
	$sqlss = "SELECT * FROM `admin_add_item_movies`";
	$resultss = mysqli_query($conn, $sqlss);

	while ($rowsss = mysqli_fetch_array($resultss)) {
		$catalog_id = $rowsss['id'];

	?>

		<!-- Modal delete for reviews with ID  -->
		<div id="modal-delete-<?php echo $catalog_id; ?>" class="zoom-anim-dialog mfp-hide modal">
			<h6 class="modal__title">Movie delete</h6>
			<p class="modal__text">Are you sure you want to permanently delete this movie?</p>
			<div class="modal__btns">
				<a href="delete_catalog.php?ID=<?php echo $catalog_id; ?>" class="modal__btn modal__btn--apply" type="button">Delete</a>
				<button class="modal__btn modal__btn--dismiss" type="button">Dismiss</button>
			</div>
		</div>

		<div id="modal-edit-<?php echo $catalog_id; ?>" class="zoom-anim-dialog mfp-hide modal">
			<h6 class="modal__title">Movie edit</h6>
			<p class="modal__text">Are you sure you want to edit this movie?</p>
			<div class="modal__btns">
				<a href="edit_catalog.php?ID=<?php echo $catalog_id; ?>" class="modal__btn modal__btn--apply" type="button">Edit</a>
				<button class="modal__btn modal__btn--dismiss" type="button">Dismiss</button>
			</div>
		</div>
