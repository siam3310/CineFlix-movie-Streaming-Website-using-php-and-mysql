...
if (isset($_POST['sub'])) {
	...
	$sql = "INSERT INTO `admin_add_item_movies`(`cover`, `title`, `director`, `cast`, `description`, `release_year`, `runtime`, `quality`, `age`, `country`,`rating`, `genre`, `upload_photos`, `item_type`, `movie_file`, `link`)
