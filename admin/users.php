  ...
  <div class="sidebar">
    ...
    <div class="sidebar__nav-wrap">
      <ul class="sidebar__nav">
        ...
        <li class="sidebar__nav-item">
          <a href="https://cineflix.volkovdesign.com/main/index.php" class="sidebar__nav-link"><i class="icon ion-ios-arrow-round-back"></i>
            <span>Back to CineFlix</span></a>
        </li>
      </ul>
    </div>
    <!-- end sidebar nav -->
    ...
    <div class="sidebar__copyright">
      © CINEFLIX, 2019—2021. <br />Create by
