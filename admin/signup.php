...
if (isset($_POST['sub'])) {
	...
	$sql = "INSERT INTO `admin_signup`( `a_name`, `a_email`, `a_pass`)  VALUES ('$aname','$aemail','$apass')";
					...
					<div class="sign__content">
						...
						<form action="#" class="sign__form" method="post">
							...
							<div class="sign__group">
								<input type="text" class="sign__input" placeholder="Name" name="aname">
							</div>
							...
							<button class="sign__btn" name="sub" type="submit">Sign up</button>
							...
							<div class="sign__social">
								...
								<a class="tw" href="#"><svg viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<a class="gl" href="#"><svg xmlns='http://www.w3.org/2000/svg' class='ionicon' viewBox='0 0 512 512'>
